...
echo_and_run cd "/home/salma/DQN_DWA-Ros-Navigation-/src/openai_ros/openai_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/salma/DQN_DWA-Ros-Navigation-/src/openai_ros/openai_ros/setup.py" \
     \
    build --build-base "/home/salma/DQN_DWA-Ros-Navigation-/build/openai_ros/openai_ros" \
    install \
    --root="${DESTDIR-/}" \
