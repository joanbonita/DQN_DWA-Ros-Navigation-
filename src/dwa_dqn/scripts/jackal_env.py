...
class JackalEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.speed = 0.2 #rospy.get_param('/speed')
        # Get goal
        self.desired_pose = Pose()
        self.desired_pose.position.x = 0 #rospy.get_param('/desired_pose/x')
        self.desired_pose.position.y = 0 #rospy.get_param('/desired_pose/y')
        self.desired_pose.position.z = 0 #rospy.get_param('/desired_pose/z')
        # Get training parameters
        self.step_sleep = 1 #rospy.get_param("/step_sleep")
        self.max_incl = 1 #rospy.get_param("/max_incl")
        # Start simulator
