...
if("TRUE" STREQUAL "TRUE")
  set(manipulation_SOURCE_PREFIX /home/salma/DQN_DWA-Ros-Navigation-/src/uoz_robotics_class/manipulation)
  set(manipulation_DEVEL_PREFIX /home/salma/DQN_DWA-Ros-Navigation-/devel)
  ...
  set(manipulation_INSTALL_PREFIX /home/salma/DQN_DWA-Ros-Navigation-/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'pworsnop <pworsnop@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manipulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/salma/DQN_DWA-Ros-Navigation-/src/uoz_robotics_class/manipulation/${idir}'.  ${_report}")
    endif()
